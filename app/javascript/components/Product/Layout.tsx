...
export const Layout = (
  ...
  const { product, purchase, discount_code: discountCode, cart, hasHero, wishlists, main_section_index, restartable_subscription } = props;
  ...
  const productView = (
    <>
      ...
      <Product
        ...
        wishlists={wishlists}
        restartableSubscription={restartable_subscription ?? null}
      />
    </>
  );
