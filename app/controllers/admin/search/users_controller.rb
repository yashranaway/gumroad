...
class Admin::Search::UsersController < Admin::BaseController
  ...
  def index
    ...
    list_paginated_users(users: @users, template: "Admin/Search/Users/Index", legacy_template: "admin/search/users/index", single_result_redirect_path: method(:admin_user_path))
  end
end
